  ...
  group('HomeState', () {
    ...
    group('CategoriesError', () {
      test('should be equal when messages are the same', () {
        // Arrange & Act
        const state1 = CategoriesError(message: 'Network error');
        const state2 = CategoriesError(message: 'Network error');
      ...
      test('should not be equal when messages are different', () {
        // Arrange & Act
        const state1 = CategoriesError(message: 'Network error');
        const state2 = CategoriesError(message: 'API error');
    ...
    group('BreedsError', () {
      test('should be equal when messages are the same', () {
        // Arrange & Act
        const state1 = BreedsError(message: 'Network error');
        const state2 = BreedsError(message: 'Network error');
      ...
      test('should not be equal when messages are different', () {
        // Arrange & Act
        const state1 = BreedsError(message: 'Network error');
        const state2 = BreedsError(message: 'API error');
